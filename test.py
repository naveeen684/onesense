...
if __name__ == "__main__":
    ...
    # Use a loop to continuously capture and process audio
    with sr.Microphone() as mic:
        ...
        while True:
            ...
            generators = chat.generate_chat_reply_wrapper(Text, '', state)           
    ...
    #     transcription = do_stt(audio, "small.en", "english")
        # generators = chat.generate_chat_reply_wrapper("Extract medicine names, dosage and time from the below sentence, Take Paracetomal 3 times a day after meal and take aspiring at night and ascoril syrup 5 ml night after food", '', state)
        # generators = chat.generate_chat_reply_wrapper(transcription, '', state)